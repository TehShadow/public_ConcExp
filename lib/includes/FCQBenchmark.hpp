...
//Time Tests
template <class X, class Y,class Z>
void Benchmark<X,Y,Z>::__ADD_THEN_REMOVE_TIME__(){
    ...
    this->threadhandles[i] = std::thread(&Benchmark<X,Y,Z>::thread_add_then_remove_time,this,i);
...
template <class X, class Y,class Z>
void Benchmark<X,Y,Z>::thread_add_then_remove_time(int id){
    {
    ...
    int count = 0;
    while(!TimeFlag){
        this->ds->FcQueueApplyEnqueue(&this->vector[id],count+1);
        this->ds->FcQueueApplyDequeue(&this->vector[id]);
...
template <class X, class Y,class Z>
void Benchmark<X,Y,Z>::__RANDOM_ADD_OR_DEQUEUE_TIME__(){
    ...
    this->threadhandles[i] = std::thread(&Benchmark<X,Y,Z>::thread_random_add_or_dequeue_time,this,i);
...
template <class X, class Y,class Z>
void Benchmark<X,Y,Z>::thread_random_add_or_dequeue_time(int id){
    srand(10);
    int random = rand();
    int choice = 0;
    {
...
// Actions Tests
template <class X, class Y,class Z>
void Benchmark<X,Y,Z>::__RANDOM_ADD_OR_DEQUEUE__(){
    ...
    this->threadhandles[i] = std::thread(&Benchmark<X,Y,Z>::thread_random_add_or_dequeue,this,i);
...
template <class X, class Y,class Z>
void Benchmark<X,Y,Z>::thread_random_add_or_dequeue(int id){
    srand(10);
    int random = rand();
    int choice = 0;
    {
    ...
    for(long i=this->partitions*(id);i<this->partitions*(id+1);i++){
        ...
        if(choice == 0){
            this->ds->FcQueueApplyEnqueue(&this->vector[id],i);
        }
        else{
            this->ds->FcQueueApplyDequeue(&this->vector[id]);
        }
...
void Benchmark<X,Y,Z>::__ADD__(){
    ...
    this->threadhandles[i] = std::thread(&Benchmark<X,Y,Z>::thread_add,this,i);
...
template <class X, class Y,class Z>
void Benchmark<X,Y,Z>::thread_add(int id){
    {
        std::lock_guard<std::mutex> Guardlock(guardian);
        std::cout << "  Thread #" << id << ": on CPU " << sched_getcpu() << "\n";
    }
...
template <class X, class Y,class Z>
void Benchmark<X,Y,Z>::__REMOVE__(){
    ...
    this->threadhandles[i] = std::thread(&Benchmark<X,Y,Z>::thread_remove,this,i);
...
template <class X, class Y,class Z>
void Benchmark<X,Y,Z>::thread_remove(int id){
    {
        std::lock_guard<std::mutex> Guardlock(guardian);
        std::cout << "  Thread #" << id << ": on CPU " << sched_getcpu() << "\n";
    }
...
template <class X, class Y,class Z>
void Benchmark<X,Y,Z>::__ADD_THEN_REMOVE__(){
    ...
    this->threadhandles[i] = std::thread(&Benchmark<X,Y,Z>::thread_add_then_remove,this,i);
...
template <class X, class Y,class Z>
void Benchmark<X,Y,Z>::thread_add_then_remove(int id){
    {
        std::lock_guard<std::mutex> Guardlock(guardian);
        std::cout << "  Thread #" << id << ": on CPU " << sched_getcpu() << "\n";
    }
...
template <class X, class Y,class Z>
void Benchmark<X,Y,Z>::full_bench(int iteration){
...
template <class X, class Y,class Z>
void Benchmark<X,Y,Z>::half_bench(int iterations){
...
template <class X, class Y,class Z>
std::string Benchmark<X,Y,Z>::get_current_dir(){
...
template <class X, class Y,class Z>
void Benchmark<X ,Y,Z>::save_logs(long long actions, long long time)
{   
...
template <class X, class Y,class Z>
void Benchmark<X,Y,Z>::create_dir(std::string path, std::string name)
{
...
template <class X, class Y,class Z>
void Benchmark<X,Y,Z>::localwork()
{
    srand(10);
