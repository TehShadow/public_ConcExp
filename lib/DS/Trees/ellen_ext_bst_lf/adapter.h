...
#include <iostream>
#include <csignal>
#include "./includeDir/errors.h"
#ifdef USE_TREE_STATS
#define TREE_STATS_BYTES_AT_DEPTH
#include "./includeDir/tree_stats.h"
#endif
#include "ellen_impl.h"
#include "./includeDir/random_fnv1a.h"
...
public:
    ds_adapter(const int NUM_THREADS,
        ...
        : NO_VALUE(VALUE_RESERVED), ds(new DATA_STRUCTURE_T(NUM_THREADS, KEY_MIN, KEY_MAX, NO_VALUE, 0 /* unused */))
    {
    }
    ~ds_adapter()
    {
